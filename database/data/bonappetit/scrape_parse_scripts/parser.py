...
gluten_list = {
    ...
    'all purpose flour': 'flour ratio',
    'all-purpose flour': 'flour ratio',
    'semolina flour': 'flour ratio',
    'cake flour': 'flour ratio',
    'white whole wheat flour': 'flour ratio',
    'regular whole wheat flour': 'flour ratio',
    'durum wheat flour': 'flour ratio',
    'whole wheat pastry flour': 'flour ratio',
    'whole wheat flour': 'flour ratio',
    'bread flour': 'flour ratio',
    'graham flour': 'flour ratio',
    'instant flour': 'flour ratio',
    'Wondra': 'flour ratio',
    'matzo cake meal': 'flour ratio',
    'pastry flour': 'flour ratio',
    'pumpernickel flour': 'flour ratio',
    'rye flour':'flour ratio',
    'self-rising flour': 'flour ratio',
    'spelt flour': 'flour ratio',
    'whole wheat bread flour': 'flour ratio',
    'durum flour': 'flour ratio',
    'kamut flour': 'flour ratio',
    'barley flour': 'flour ratio',
    'triticale flour': 'flour ratio',
    'wholemeal flour': 'flour ratio',
    'gluten flour': 'flour ratio',
    'enriched flour': 'flour ratio',
    'plain flour': 'flour ratio',
    'atta flour': 'flour ratio',
    'maida flour': 'flour ratio',
    'noodle flour': 'flour ratio',
    'high gluten flour': 'flour ratio',
    'first clear flour': 'flour ratio',
    'enriched all-purpose flour': 'flour ratio',
    'bleached enriched all-purpose flour': 'flour ratio',
    'unbleached enriched all-purpose flour': 'flour ratio',
    'bleached all-purpose flour': 'flour ratio',
    'unbleached all-purpose flour': 'flour ratio',
    'bolted flour': 'flour ratio',
    'self-rising cake flour': 'flour ratio',
    'clear flour': 'flour ratio',
    'farina': 'flour ratio',
    'cream of wheat': 'flour ratio',
    'patent flour': 'flour ratio',
    'extra short patent flour': 'flour ratio',
    'fancy patent flour': 'flour ratio',
    'first patent flour': 'flour ratio',
    'medium patent flour': 'flour ratio',
    'long patent flour': 'flour ratio',
    'fancy clear flour': 'flour ratio',
    'second clear flour': 'flour ratio',
    'stuffed straight flour': 'flour ratio',
    'straight flour': 'flour ratio',
    'vital wheat gluten': 'flour ratio',
    'wheat germ': 'flour ratio',
    'wheat bran': 'flour ratio',
    'unprocessed bran': 'flour ratio',
    'plain wholemeal flour': 'flour ratio',
    'hard whole wheat flour': 'flour ratio',
    'stone ground whole wheat flour': 'flour ratio',
    'whole wheat white flour':'flour ratio',
    'not a match': 'Safe'
}
...
light_ratio = {}
light_ratio['protein'] = {'type':'sorghum flour', 'weight':.165}
light_ratio['fat'] = {'type':'cashew flour', 'weight':.165}
light_ratio['lightness'] = {'type':'white rice flour', 'weight':.33}
light_ratio['stickiness'] = ""
light_ratio['texture'] = ""
light_ratio['density'] = ""
light_ratio['starch'] = {'type':'cornstarch', 'weight':.33}
light_ratio['binder'] = {'type':'xanthum gum', 'weight':.5}
light_ratio['leavener'] = ""

regular_ratio = {}
regular_ratio['protein'] = {'type':'sorghum flour','weight': .142}
regular_ratio['fat'] = {'type':'almond flour','weight': .142}
regular_ratio['lightness'] = {'type':'white rice flour', 'weight':.284}
regular_ratio['stickiness'] = ""
regular_ratio['density'] = {'type':'brown rice flour','weight': .142}
regular_ratio['texture'] = ""
regular_ratio['starch'] = {'type':'potato starch', 'weight':.284}
regular_ratio['binder'] = {'type':'xanthum gum', 'weight':.5}
regular_ratio['leavener'] = ""

dense_ratio = {}
dense_ratio['protein'] = {'type':'sorghum flour', 'weight':.25}
dense_ratio['fat'] = {'type':'walnut flour', 'weight':.125}
dense_ratio['lightness'] = {'type':'oat flour', 'weight':.125}
dense_ratio['stickiness'] = ""
dense_ratio['density'] = {'type':'buckwheat flour', 'weight':.25}
dense_ratio['texture'] = ""
dense_ratio['starch'] = {'type':'potato starch','weight': .25}
dense_ratio['binder'] = {'type':'xanthum gum', 'weight':1}
dense_ratio['leavener'] = ""

light_textured_ratio = {}
light_textured_ratio['protein'] = {'type':'sorghum flour', 'weight':.142}
light_textured_ratio['fat'] = {'type':'almond flour', 'weight':.142}
light_textured_ratio['lightness'] = {'type':'teff flour', 'weight':.285}
light_textured_ratio['stickiness'] = ""
light_textured_ratio['density'] = ""
light_textured_ratio['texure'] = {'type':'millet flour', 'weight':.142}
light_textured_ratio['starch'] = {'type':'tapioca starch','weight': .285}
light_textured_ratio['binder'] = {'type':'xanthum gum','weight': .5}
light_textured_ratio['leavener'] = ""

dense_textured_ratio = {}
dense_textured_ratio['protein'] = {'type':'sorghum flour', 'weight':.142}
dense_textured_ratio['fat'] = {'type':'hazelnut flour', 'weight':.142}
dense_textured_ratio['lightness'] = {'type':'corn flour', 'weight':.142}
dense_textured_ratio['stickiness'] = ""
dense_textured_ratio['density'] = {'type':'potato flour','weight': .142}
dense_textured_ratio['texure'] = {'type':'hemp flour','weight': .142}
dense_textured_ratio['starch'] = {'type':'potato starch','weight': .285}
dense_textured_ratio['binder'] = {'type':'xanthum gum', 'weight': 1}
dense_textured_ratio['leavener'] = ""

light_sticky_ratio = {}
light_sticky_ratio['protein'] = {'type':'sorghum flour', 'weight':.125}
light_sticky_ratio['fat'] = {'type':'almond flour', 'weight':.25}
light_sticky_ratio['lightness'] = {'type':'teff flour', 'weight':.125}
light_sticky_ratio['stickiness'] = {'type':'sweet rice flour','weight': .25}
light_sticky_ratio['density'] = ""
light_sticky_ratio['texture'] = ""
light_sticky_ratio['starch'] = {'type':'arrowroot starch', 'weight':.25}
light_sticky_ratio['binder'] = {'type':'guar gum', 'weight': 1}
light_sticky_ratio['leavener'] = ""

regular_sticky_ratio = {}
regular_sticky_ratio['protein'] = {'type':'sorghum flour', 'weight':.11}
regular_sticky_ratio['fat'] = {'type':'chesnut flour', 'weight':.22}
regular_sticky_ratio['lightness'] = {'type':'white rice flour', 'weight':.11}
regular_sticky_ratio['stickiness'] = {'type':'amaranth flour','weight': .11}
regular_sticky_ratio['density'] = {'type':'brown rice flour', 'weight':.22}
regular_sticky_ratio['texure'] = ""
regular_sticky_ratio['starch'] = {'type':'potato starch','weight': .22}
regular_sticky_ratio['binder'] = {'type':'guar gum', 'weight': 1}
regular_sticky_ratio['leavener'] = ""

dense_sticky_ratio = {}
dense_sticky_ratio['protein'] = {'type':'sorghum flour', 'weight':.2}
dense_sticky_ratio['fat'] = {'type':'hazelnut flour','weight': .2}
dense_sticky_ratio['lightness'] = {'type':'white rice flour','weight': .1}
dense_sticky_ratio['stickiness'] = {'type':'amaranth flour','weight': .1}
dense_sticky_ratio['density'] = {'type':'buckwheat flour','weight': .2}
dense_sticky_ratio['texure'] = ""
dense_sticky_ratio['starch'] = {'type':'acorn starch', 'weight':.2}
dense_sticky_ratio['binder'] = {'type':'guar gum','weight': 1}
dense_sticky_ratio['leavener'] = ""

light_rising_ratio = {}
light_rising_ratio['protein']= {'type':'sorghum flour', 'weight':.164}
light_rising_ratio['fat'] = {'type':'almond flour', 'weight':.164}
light_rising_ratio['lightness'] = {'type':'white rice flour','weight': .328}
light_rising_ratio['stickiness'] = ""
light_rising_ratio['density'] = ""
light_rising_ratio['texure'] = ""
light_rising_ratio['starch'] = {'type':'cornstarch', 'weight':.328}
light_rising_ratio['binder'] = {'type':'xanthum gum','weight': 1}
light_rising_ratio['leavener'] = {'type':'baking powder', 'weight':1}

dense_rising_ratio = {}
dense_rising_ratio['protein'] = {'type':'sorghum flour', 'weight':.25}
dense_rising_ratio['fat'] = {'type':'almond flour','weight': .125}
dense_rising_ratio['lightness'] = {'type':'white rice flour', 'weight':.125}
dense_rising_ratio['stickiness'] = ""
dense_rising_ratio['density'] = {'type':'brown rice flour', 'weight':.25}
dense_rising_ratio['texure'] = ""
dense_rising_ratio['starch'] = {'type':'potato starch', 'weight':.25}
dense_rising_ratio['binder'] = {'type':'xanthum gum', 'weight':1}
dense_rising_ratio['leavener'] = {'type':'baking powder', 'weight':1}
...
'all-purpose flour': {'type':regular_ratio, 'weight':125},
    ...
    'matzo cake meal': {'type':light_ratio, 'weight': 152},
    ...
    'first patent flour': {'type':regular_ratio, 'weight': 152}, 'short patent flour': {'type':regular_sticky_ratio, 'weight': 152},
    ...
    try:
        ...
        for i in range(len(ingredients)):
            ...
            if unit == "":
                ...
                flourratio = swap_flour(name)
                if flourratio != "Safe":
                        print flourratio, recipe['name'], quantity, unit
                glutenstat = check_gluten(name)
                sub = check_sub(name)
